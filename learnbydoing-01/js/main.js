...
function finished(){
  ...
  if (errors == 0) {
    $("#score").html("<p>Perfect, 18 HTML tags created, with " + errors + " errors in " + timer + "seconds, Very Nice Work!</p> <p>These heading elements are key to helping people find the information found on your website. Don't use h1 more than onoce as it should be the most important text on your website.</p> <p>To practice again, hit the reset button at the bottom of your screen.</p>")
  } else {
    $("#score").html("<p>18 HTML tags created, with only " + errors + " errors in " + timer + " seconds, Nice Work!</p> <p>These heading elements are key to helping people find the information found on your website. Don't use h1 more than onoce as it should be the most important text on your website.</p> <p>To practice again, hit the reset button at the bottom of your screen.</p>")
  }
}
